        ...
        <header className="pt-8 sm:pt-12">
          <div className="flex items-baseline justify-between gap-4">
            ...
            <a
              ...
              className="flex shrink-0 items-center gap-1.5 text-sm font-medium text-faint transition-colors hover:text-ink"
            >
          ...
          <p className="mt-5 border-y border-line py-2.5 text-xs font-medium uppercase tracking-wider text-faint">
            <span aria-hidden className="mr-1.5 text-sun">
              ✶
            </span>
