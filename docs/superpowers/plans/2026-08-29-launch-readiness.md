...
- [x] **Step 1: Write a failing merge test**
...
- [x] **Step 3: Implement terminal registry deactivation**
...
- [x] **Step 2: Implement request timeouts**
...
- [x] **Step 1: Add accessible names and focus styles**
...
- [x] **Step 1: Update source-faithful copy**
...
- [x] **Step 2: Add privacy-minimal custom events**
...
- [x] **Step 1: Search official ATS-hosted pages**
...
- [x] **Step 4: Commit additions or the documented no-add result**
...
- [x] **Step 1: Run one final refresh**
